...
void kin_wEKFwoExtPos_Estimate(sModelStates &pOutModelStates_s, matrix<double>& pOutP_m, sVehicleParameters pVehicleParameters_s, sMeasuredValues pMeasuredValues_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d, matrix<double>& pPrevP_m, matrix<double>& pQ_m, matrix<double>& pR_m) {
	double lYawAngle_d = kin_wEKFwoExtPos_YawAngleCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	...
	double lLongitudinalVelocity_d = kin_wEKFwoExtPos_LongitudinalVelocityCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lLateralVelocity_d = kin_wEKFwoExtPos_LateralVelocityCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lBeta_d = kin_wEKFwoExtPos_BetaCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lYawRate_d = kin_wEKFwoExtPos_YawRateCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d, lLongitudinalVelocity_d, lBeta_d);
	double lLateralAcc_d = kin_wEKFwoExtPos_LateralAccCalculation(pVehicleParameters_s, pMeasuredValues_s, lBeta_d, lYawRate_d);
	double lPositionX_d = kin_wEKFwoExtPos_PositionXCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lPositionY_d = kin_wEKFwoExtPos_PositionYCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lMeasBasedLateralVelocity_d = kin_wEKFwoExtPos_MeasBasedLateralVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);
	double lMeasBasedLongitudinalVelocity_d = kin_wEKFwoExtPos_MeasBasedLongitudinalVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);
...
//	double lMeasPositionY_d = pPrevMeasuredValues_s.iPosition1Y_d;
	...
	lH_m(2, 0) = tan(lBeta_d) / pVehicleParameters_s.iL2_d;
	lH_m(2, 1) = 0;
	lH_m(2, 2) = 0;
	lH_m(2, 3) = 0;
	lH_m(2, 4) = 0;
