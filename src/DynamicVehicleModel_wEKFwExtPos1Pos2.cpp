...
double dyn_wEKFwExtPos1Pos2_LongitudinalVelocityCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pMeasuredValues_s, double pTs_d) {
...
double dyn_wEKFwExtPos1Pos2_LateralVelocityCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pMeasuredValues_s, double pTs_d) {
...
double dyn_wEKFwExtPos1Pos2_BetaCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d) {
...
double dyn_wEKFwExtPos1Pos2_YawRateCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d) {
	double lReturnValue_d = 0;
	double lPrevVehicleSpeed_d = 0;
	//if (cos(pPrevModelStates_s.iBeta_d) != 0) {
	//	lPrevVehicleSpeed_d = pPrevMeasuredValues_s.iVehicleSpeed_d / cos(pPrevModelStates_s.iBeta_d); // vx / cos(beta)
...
double dyn_wEKFwExtPos1Pos2_LateralAccCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pMeasuredValues_s, double pBeta_d, double pYawRate_d) {
...
double dyn_wEKFwExtPos1Pos2_YawAngleCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d) {
	double lReturnValue_d = 0;
...
double dyn_wEKFwExtPos1Pos2_PositionXCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d) {
	double lReturnValue_d = 0;
...
double dyn_wEKFwExtPos1Pos2_PositionYCalculation(sVehicleParameters pVehicleParameters_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d) {
	double lReturnValue_d = 0;
...
void dyn_wEKFwExtPos1Pos2_Estimate(sModelStates &pOutModelStates_s, matrix<double> &pOutP_m, sVehicleParameters pVehicleParameters_s, sMeasuredValues pMeasuredValues_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d, matrix<double> &pPrevP_m, matrix<double> &pQ_m, matrix<double> &pR_m) {
	double lYawRate_d			    = dyn_wEKFwExtPos1Pos2_YawRateCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lYawAngle_d			    = dyn_wEKFwExtPos1Pos2_YawAngleCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lPrevYawAngle_d		    = pPrevModelStates_s.iYawAngle_d;
	double lBeta_d				    = dyn_wEKFwExtPos1Pos2_BetaCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lLateralAcc_d		    = dyn_wEKFwExtPos1Pos2_LateralAccCalculation(pVehicleParameters_s, pMeasuredValues_s, lBeta_d, lYawRate_d);
	double lPositionX_d			    = dyn_wEKFwExtPos1Pos2_PositionXCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lPositionY_d			    = dyn_wEKFwExtPos1Pos2_PositionYCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lLateralVelocity_d       = dyn_wEKFwExtPos1Pos2_LateralVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);
	double lLongitudinalVelocity_d  = dyn_wEKFwExtPos1Pos2_LongitudinalVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);
	double lMeasYawRate_d		    = pPrevMeasuredValues_s.iYawRate_d;
	double lMeasYawAngle1_d		    = pPrevMeasuredValues_s.iYawAngle1_d;
	double lMeasYawAngle2_d		    = pPrevMeasuredValues_s.iYawAngle2_d;
	double lMeasLateralAcc_d		= pPrevMeasuredValues_s.iLateralAcceleration_d;
	double lMeasPosition1X_d		= pPrevMeasuredValues_s.iPosition1X_d;
	double lMeasPosition1Y_d		= pPrevMeasuredValues_s.iPosition1Y_d;
	double lMeasPosition2X_d		= pPrevMeasuredValues_s.iPosition2X_d;
	double lMeasPosition2Y_d		= pPrevMeasuredValues_s.iPosition2Y_d;
	...
	ly_v(1) = lMeasYawAngle1_d;
	ly_v(2) = lMeasYawAngle2_d;
	ly_v(3) = lMeasLateralAcc_d;
	ly_v(4) = lMeasPosition1X_d;
	ly_v(5) = lMeasPosition1Y_d;
	ly_v(6) = lMeasPosition2X_d;
	ly_v(7) = lMeasPosition2Y_d;
	...
	if (lPrevMeasVehicleSpeed_d != 0) {
		...
		lH_m(1, 0) = 0;
		lH_m(2, 0) = 0;
		lH_m(3, 0) = -(pVehicleParameters_s.iC1_d + pVehicleParameters_s.iC2_d) / pVehicleParameters_s.iM_d;
		lH_m(4, 0) = 0;
		lH_m(5, 0) = 0;
		lH_m(6, 0) = 0;
		lH_m(7, 0) = 0;
		...
		lH_m(1, 1) = 0;
		lH_m(2, 1) = 0;
		lH_m(3, 1) = (pVehicleParameters_s.iC2_d * pVehicleParameters_s.iL2_d - pVehicleParameters_s.iC1_d * pVehicleParameters_s.iL1_d) / (pVehicleParameters_s.iM_d * lPrevMeasVehicleSpeed_d);
		lH_m(4, 1) = 0;
		lH_m(5, 1) = 0;
		lH_m(6, 1) = 0;
		lH_m(7, 1) = 0;
