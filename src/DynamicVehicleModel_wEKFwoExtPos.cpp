...
void dyn_wEKFwoExtPos_Estimate(sModelStates &pOutModelStates_s, matrix<double>& pOutP_m, sVehicleParameters pVehicleParameters_s, sMeasuredValues pMeasuredValues_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d, matrix<double>& pPrevP_m, matrix<double>& pQ_m, matrix<double>& pR_m, bool pUseYawAngle_b) {
	double lYawRate_d = dyn_wEKFwoExtPos_YawRateCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lYawAngle_d = dyn_wEKFwoExtPos_YawAngleCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lPrevYawAngle_d = pPrevModelStates_s.iYawAngle_d;
	double lBeta_d = dyn_wEKFwoExtPos_BetaCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lLateralAcc_d = dyn_wEKFwoExtPos_LateralAccCalculation(pVehicleParameters_s, pMeasuredValues_s, lBeta_d, lYawRate_d);
	double lPositionX_d = dyn_wEKFwoExtPos_PositionXCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lPositionY_d = dyn_wEKFwoExtPos_PositionYCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lLateralVelocity_d = dyn_wEKFwoExtPos_LateralVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);
	double lLongitudinalVelocity_d = dyn_wEKFwoExtPos_LongitudinalVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);
	...
	if (pUseYawAngle_b) {
		...
		//ly_v(1) = pPrevModelStates_s.iYawAngle_d + lMeasYawRate_d * pTs_d;
		//double lTmpBeta_d = atan(tan(pMeasuredValues_s.iSteeringAngle_d) * (pVehicleParameters_s.iL2_d / (pVehicleParameters_s.iL2_d + pVehicleParameters_s.iL1_d)));
		ly_v(1) = pPrevModelStates_s.iYawAngle_d + pTs_d*(pMeasuredValues_s.iVehicleSpeed_d * sin(atan(tan(pMeasuredValues_s.iSteeringAngle_d) * (pVehicleParameters_s.iL2_d / (pVehicleParameters_s.iL2_d + pVehicleParameters_s.iL1_d)))) /	pVehicleParameters_s.iL2_d);
				//pPrevModelStates_s.iYawAngle_d + pTs_d*(pMeasuredValues_s.iVehicleSpeed_d *((tan(pMeasuredValues_s.iSteeringAngle_d) * cos(lTmpBeta_d)) / (pVehicleParameters_s.iL2_d + pVehicleParameters_s.iL1_d)));
	}
