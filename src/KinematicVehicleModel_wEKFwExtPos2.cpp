...
void kin_wEKFwExtPos2_Estimate(sModelStates &pOutModelStates_s, matrix<double>& pOutP_m, sVehicleParameters pVehicleParameters_s, sMeasuredValues pMeasuredValues_s, sMeasuredValues pPrevMeasuredValues_s, sModelStates pPrevModelStates_s, double pTs_d, matrix<double>& pPrevP_m, matrix<double>& pQ_m, matrix<double>& pR_m) {
	double lYawAngle_d						= kin_wEKFwExtPos2_YawAngleCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	...
	double lLongitudinalVelocity_d			= kin_wEKFwExtPos2_LongitudinalVelocityCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lLateralVelocity_d				= kin_wEKFwExtPos2_LateralVelocityCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lBeta_d							= kin_wEKFwExtPos2_BetaCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lYawRate_d						= kin_wEKFwExtPos2_YawRateCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d, lLongitudinalVelocity_d, lBeta_d);
	double lLateralAcc_d					= kin_wEKFwExtPos2_LateralAccCalculation(pVehicleParameters_s, pMeasuredValues_s, lBeta_d, lYawRate_d);
	double lPositionX_d						= kin_wEKFwExtPos2_PositionXCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lPositionY_d						= kin_wEKFwExtPos2_PositionYCalculation(pVehicleParameters_s, pPrevMeasuredValues_s, pPrevModelStates_s, pTs_d);
	double lMeasBasedLateralVelocity_d		= kin_wEKFwExtPos2_MeasBasedLateralVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);
	double lMeasBasedLongitudinalVelocity_d = kin_wEKFwExtPos2_MeasBasedLongitudinalVelocityCalculation(pVehicleParameters_s, pMeasuredValues_s, pTs_d);

	double lMeasYawRate_d			= pPrevMeasuredValues_s.iYawRate_d;
	double lMeasYawAngle_d			= pPrevMeasuredValues_s.iYawAngle2_d;
	double lMeasLateralAcc_d		= pPrevMeasuredValues_s.iLateralAcceleration_d;
	double lMeasPositionX_d			= pPrevMeasuredValues_s.iPosition2X_d;
	double lMeasPositionY_d			= pPrevMeasuredValues_s.iPosition2Y_d;
