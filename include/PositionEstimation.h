...
class cPositionEstimation {
    ...
    public:
        cPositionEstimation(bool pDynamicTimeCalcEnabled_b, int pLoopRateHz_i32, std::string pVehicleType_s, float pKinematicModelMaxSpeed_f);
        ~cPositionEstimation();
        void initEstimation(bool pDynamicTimeCalcEnabled_b, int pLoopRateHz_i32, std::string pVehicleType_s, float pKinematicModelMaxSpeed_f);
